...
* [Регистрация и подготовка](#регистрация-и-подготовка)  
  ...
  * [Загрузка WEBP изображений в формате JPEG](#Загрузка-WEBP-изображений-в-формате-JPEG)  
...
### Загрузка WEBP изображений в формате JPEG  

Начиная с обработкии версии 1.0.0 добавили возможность скачивать файлы из сообщений в формате JPEG, если это возможно.  

Для получения изображений в формате JPEG необходимо перейти на соответствующую страницу настройки и установить галочку 
напротив пункта меню "Загружать WEBP изображения в формате JPEG".  

![webp](./media/webpToJpeg.png)  
